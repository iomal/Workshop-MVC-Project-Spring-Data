...
public class HomeController extends BaseController {
    ...
    @Autowired
    public HomeController(BranchService branchService, EmployeeService employeeService, ClientService clientService,
                          BankAccountService bankAccountService, CardService cardService) {
